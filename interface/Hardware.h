...
private:
    ...
    virtual void signalSegmentComplete()=0;

    virtual void setEmptyLed(PinVal value) = 0;
    virtual void setRunningLed(PinVal value) = 0;
    virtual void setBuiltinLed(PinVal value) = 0;
    virtual void setYLed(PinVal value) = 0;
    virtual void setBLed(PinVal value) = 0;
...
public:
    ...
    void disable() { setDirection(STOP); hw->writePin(enable_pin, !enable_val);}
